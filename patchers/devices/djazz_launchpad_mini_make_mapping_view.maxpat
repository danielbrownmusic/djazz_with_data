...
,
		"classnamespace" : "box",
		"rect" : [ -1267.0, -146.0, 1124.0, 1086.0 ],
		"bglocked" : 0,
...
,
					"patching_rect" : [ 105.0, 234.0, 127.0, 22.0 ],
...
,
					"patching_rect" : [ 105.0, 296.0, 125.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 228.5, 581.0, 116.0, 49.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 105.0, 750.0, 102.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 674.0, 34.0, 48.0, 44.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 387.0, 2.0, 35.0, 22.0 ],
					"text" : "clear",
					"texton" : "clear"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 295.0, 160.0, 52.0, 22.0 ],
									"text" : "append"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 118.0, 402.0, 96.0, 22.0 ],
									"text" : "prepend append"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "", "", "", "", "" ],
									"patching_rect" : [ 50.0, 296.0, 88.0, 62.0 ],
									"text" : "route bar chapter chapter_count grid"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 152.0, 68.0, 22.0 ],
									"text" : "get_names"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 217.0, 197.0, 22.0 ],
									"saved_object_attributes" : 									{
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 200.5, 484.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 295.0, 99.0, 108.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 295.0, 30.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 105.0, 477.0, 51.0, 35.0 ],
					"text" : "unpack midi 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 105.0, 893.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 478.5, 177.0, 58.0, 22.0 ],
					"text" : "t b s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 105.0, 581.0, 94.0, 76.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 466.0, 34.0, 44.0, 44.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 279.0, 2.0, 23.0, 22.0 ],
					"text" : "red",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 510.0, 34.0, 44.0, 44.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 304.0, 2.0, 23.0, 22.0 ],
					"text" : "orange",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 554.0, 34.0, 44.0, 44.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 329.0, 2.0, 23.0, 22.0 ],
					"text" : "yellow",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 598.0, 34.0, 44.0, 44.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 356.0, 2.0, 23.0, 22.0 ],
					"text" : "green",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 105.0, 99.0, 126.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 105.0, 177.0, 94.0, 22.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 527.0, 546.5, 189.5, 546.5 ],
					"source" : [ "obj-15", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 488.0, 533.5, 114.5, 533.5 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 238.0, 702.5, 114.5, 702.5 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 373.0, 519.5, 133.25, 519.5 ],
					"order" : 1,
					"source" : [ "obj-20", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 1 ],
					"midpoints" : [ 373.0, 500.5, 335.0, 500.5 ],
					"order" : 0,
					"source" : [ "obj-20", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 683.5, 561.0, 238.0, 561.0 ],
					"source" : [ "obj-33", 0 ]
				}
