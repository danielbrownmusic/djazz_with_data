...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 75.5, 198.0, 91.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 75.5, 136.0, 77.0, 22.0 ],
									"text" : "dictionary $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 66.5, 100.0, 183.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 75.5, 171.0, 83.0, 22.0 ],
									"text" : "dict.unpack 0:"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 228.034981009585408, 216.0, 22.0 ],
...
,
					"patching_rect" : [ 151.5, 352.034981009585408, 249.0, 22.0 ],
...
,
					"text" : "p set_current_beat_to_first_beat_in_beat_list"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 40.0, 259.0, 130.5, 22.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 40.0, 81.0, 126.5, 22.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 147.5, 129.0, 165.0, 22.0 ],
					"text" : "unpack uxxxxx uxxxx"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 293.5, 203.0, 221.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 147.5, 203.0, 124.0, 22.0 ],
					"text" : "pv #0_NOTES NONE"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 40.0, 406.034981009585408, 237.5, 22.0 ],
					"text" : "t l l"
				}
...
,
					"patching_rect" : [ 219.5, 602.657203231807671, 95.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 40.0, 602.657203231807671, 159.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 126.0, 176.540739009585423, 55.0, 22.0 ],
									"text" : "name $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 112.0, 395.0, 29.5, 22.0 ],
									"text" : "- 1"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 91.0, 342.0, 40.0, 22.0 ],
									"text" : "uzi"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 91.0, 284.540739009585423, 37.0, 22.0 ],
									"text" : "zl.len"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "dictionary", "", "", "" ],
									"patching_rect" : [ 70.0, 227.540739009585423, 50.5, 22.0 ],
									"saved_object_attributes" : 									{
										"embed" : 0,
										"parameter_enable" : 0,
										"parameter_mappable" : 0
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 70.0, 176.540739009585423, 50.0, 22.0 ],
									"text" : "getkeys"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 112.0, 477.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 40.0, 352.034981009585408, 88.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 105.5, 267.459260990414577, 29.5, 22.0 ],
									"text" : "< 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 119.583333333333258, 161.459260990414577, 216.0, 22.0 ],
									"text" : "pv #0_CURRENT_BEAT_DICT_NAME"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 208.459260990414577, 29.5, 22.0 ],
									"text" : "$1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 119.583333333333258, 212.051853583007642, 96.0, 22.0 ],
									"text" : "dict.unpack end:"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 68.5, 39.999970990414567, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 105.5, 349.459260990414577, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 311.0, 487.983127416992374, 154.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 258.5, 449.442388416992344, 71.5, 22.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 219.5, 545.34979582439928, 58.0, 32.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 482.416666666666515, 23.942388416992344, 219.0, 35.0 ],
...
, 			{
				"box" : 				{
					"comment" : "(list: sym sym) note list, beat list",
					"id" : "obj-61",
					"index" : 1,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 40.0, 16.000008009585372, 30.0, 30.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 320.5, 527.666461620695827, 229.0, 527.666461620695827 ],
					"source" : [ "obj-46", 0 ]
				}
