...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 111.0, 220.0, 30.0, 30.0 ],
					"varname" : "BANG"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 371.0, 9.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 27.0, 224.0, 53.0, 22.0 ],
					"text" : "pattrhub"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 27.0, 155.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 11.0, 9.0, 339.0, 117.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -3.0, -1.0, 523.0, 296.0 ],
					"varname" : "master",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 175.0, 159.0, 161.0, 22.0 ],
...
, 			{
		...
		"parameters" : 		{
			"obj-2::obj-3::obj-5" : [ "number[2]", "number", 0 ],
			"obj-2::obj-7::obj-2" : [ "number[1]", "number", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
