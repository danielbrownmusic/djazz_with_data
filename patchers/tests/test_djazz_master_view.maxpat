...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 589.0, 11.0, 35.0, 22.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 538.0, 11.0, 32.0, 22.0 ],
					"text" : "NAV"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 663.0, 11.0, 42.0, 22.0 ],
					"text" : "import"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 663.0, 64.0, 54.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 33.0, 75.0, 575.0, 301.0 ],
					"varname" : "djazz_master_view",
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-1::obj-23" : [ "tempo_out", "tempo_out", 0 ],
			"obj-1::obj-7::obj-2" : [ "number", "number", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
