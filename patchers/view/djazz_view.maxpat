...
,
					"patching_rect" : [ 809.0, 324.0, 407.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1245.0, 433.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 809.0, 88.0, 60.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2190.0, 383.0, 173.0, 20.0 ],
...
,
					"patching_rect" : [ 2116.0, 273.0, 242.601736545562744, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 2116.0, 317.0, 67.0, 22.0 ],
					"save" : [ "#N", "thispatcher", ";", "#Q", "end", ";" ],
					"text" : "thispatcher"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2016.0, 435.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 809.0, 433.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 2116.0, 151.0, 157.33333420753479, 33.333331823348999 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 2116.0, 205.0, 130.0, 22.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1958.0, 67.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1878.0, 139.0, 53.0, 22.0 ],
					"text" : "pattrhub"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1958.0, 435.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1958.0, 135.0, 107.0, 62.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1878.0, 67.0, 30.0, 30.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 818.5, 304.5, 1254.5, 304.5 ],
					"order" : 0,
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 372.5, 378.3333340883255, 2025.5, 378.3333340883255 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-32", 0 ],
					"midpoints" : [ 295.5, 378.552084710991949, 2025.5, 378.552084710991949 ],
					"source" : [ "obj-45", 1 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-45::obj-11::obj-22" : [ "score_2_transpose_pitch[10]", "score_1_transpose_pitch", 0 ],
			...
			"obj-45::obj-12::obj-22" : [ "score_2_transpose_pitch[11]", "score_1_transpose_pitch", 0 ],
			...
			"obj-45::obj-13::obj-22" : [ "score_2_transpose_pitch[19]", "score_1_transpose_pitch", 0 ],
			...
			"obj-45::obj-2::obj-22" : [ "score_2_transpose_pitch[9]", "score_1_transpose_pitch", 0 ],
